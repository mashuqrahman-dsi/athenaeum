...
public class Information extends TableImpl<InformationRecord> {
	 ...
	 */
	public final TableField<InformationRecord, Integer> INFORMATIONID = createField(
			"INFORMATIONID",
	 ...
	 */
	public final TableField<InformationRecord, Integer> REQUESTID = createField(
			"REQUESTID", org.jooq.impl.SQLDataType.INTEGER.nullable(false),
			this, "");

	/**
	 * The column <code>ATHENAEUM.INFORMATION.REFERENCE</code>.
	 */
	public final TableField<InformationRecord, String> REFERENCE = createField(
			"REFERENCE", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false),
			this, "");

	/**
	 * The column <code>ATHENAEUM.INFORMATION.STATUS</code>.
	 */
	public final TableField<InformationRecord, String> STATUS = createField(
	 ...
	 */
	public final TableField<InformationRecord, String> DATA = createField(
			"DATA", org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
	...
	public List<ForeignKey<InformationRecord, ?>> getReferences() {
		return Arrays
				.<ForeignKey<InformationRecord, ?>>asList(Keys.CONSTRAINT_F);
	}
