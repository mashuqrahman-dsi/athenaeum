...
public class Request extends TableImpl<RequestRecord> {
     ...
     */
    public final TableField<RequestRecord, Integer> REQUESTID = createField("REQUESTID", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>ATHENAEUM.REQUEST.BOOKID</code>.
     */
    public final TableField<RequestRecord, Integer> BOOKID = createField("BOOKID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>ATHENAEUM.REQUEST.STATUS</code>.
     */
    public final TableField<RequestRecord, String> STATUS = createField("STATUS", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.CONSTRAINT_INDEX_6, Indexes.PRIMARY_KEY_6);
    }
