...
public class InformationRecord extends UpdatableRecordImpl<InformationRecord> implements Record5<Integer, Integer, String, String, String> {
     ...
     */
    @Override
    public InformationRecord values(Integer value1, Integer value2, String value3, String value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public InformationRecord(Integer informationid, Integer requestid, String reference, String status, String data) {
        super(Information.INFORMATION);
